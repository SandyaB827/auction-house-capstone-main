...
namespace TheAuctionHouse.Data.EFCore.SQLite.Migrations
{
    ...
    [Migration("20250526103822_AddWalletTransactionEntity")]
    partial class AddWalletTransactionEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TheAuctionHouse.Domain.Entities.WalletTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("TheAuctionHouse.Domain.Entities.WalletTransaction", b =>
                {
                    b.HasOne("TheAuctionHouse.Domain.Entities.Asset", "RelatedAsset")
                        .WithMany()
                        .HasForeignKey("RelatedAssetId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("TheAuctionHouse.Domain.Entities.Auction", "RelatedAuction")
                        .WithMany()
                        .HasForeignKey("RelatedAuctionId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("TheAuctionHouse.Domain.Entities.PortalUser", "User")
